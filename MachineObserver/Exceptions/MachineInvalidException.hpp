...
class MachineInvalidChildException : public Umati::Exceptions::UmatiException {
 public:
  ...
  MachineInvalidChildException(const std::string& err, bool hasInvalidMandatoryChild)
    : hasInvalidMandatoryChild(hasInvalidMandatoryChild), Umati::Exceptions::UmatiException(err){};
};
}  // namespace Exceptions
}  // namespace MachineObserver
}  // namespace Umati
