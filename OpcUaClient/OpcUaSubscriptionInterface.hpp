...
class OpcUaSubscriptionInterface {
 public:
  ...
  virtual UA_CreateSubscriptionResponse SessionCreateSubscription(
    ...
    UA_Client_DeleteSubscriptionCallback deleteCallback) = 0;

  virtual UA_StatusCode SessionDeleteSubscription(UA_Client *client, const UA_Int32 subscriptionId) = 0;
};
...
class OpcUaSubscriptionWrapper : public OpcUaSubscriptionInterface {
 public:
  ...
  UA_StatusCode SessionDeleteSubscription(UA_Client *client, const UA_Int32 subscriptionId) override {
