...
OpcUaNonGoodStatusCodeException::OpcUaNonGoodStatusCodeException(const UA_StatusCode &status, const std::string &message)
...
std::string OpcUaNonGoodStatusCodeException::statusToMessage(const UA_StatusCode &status) { return std::string(UA_StatusCode_name(status)); }
