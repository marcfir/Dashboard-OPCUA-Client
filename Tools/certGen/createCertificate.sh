...
declare -A SETTINGS=(["Hostnames"]="localhost" ["IPs"]="127.0.0.1 4.4.4.4" ["URI"]="http://dashboard.umati.app/OPCUA_DataClient" ["Keysize"]=2048 ["Days"]=365 ["Subject"]="/C=DE/O=SampleOrganization/CN=UmatiDashboardClient@localhost")
CONF_FILE=${ENV}.conf
