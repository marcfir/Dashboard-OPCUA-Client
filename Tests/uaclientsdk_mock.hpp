...
class MockUaDiscovery : public UaDiscovery {
 public:
  MOCK_METHOD(UaStatus, findServers, (const UaString &sDiscoveryURL, UaApplicationDescriptions &applicationDescriptions));
  ...
  MOCK_METHOD(
    UaStatus,
    queryDirectory,
    (ServiceSettings & serviceSettings, const UaString &sGdsURL, OpcUa_UInt32 startingRecordId, UaDateTime &lastCounterResetTime, UaServerOnNetworks &servers));

  MOCK_METHOD(
    UaStatus,
    queryDirectory,
    (ServiceSettings & serviceSettings, UaSession *pSession, OpcUa_UInt32 startingRecordId, UaDateTime &lastCounterResetTime, UaServerOnNetworks &servers));
  ...
  MOCK_METHOD(UaStatus, startReverseDiscovery, (const UaString &sClientEndpointUrl, UaReverseDiscoveryCallback *pReverseConnectCallback));
...
class MockUaSession : public UaSession {
 public:
  ...
  MOCK_METHOD(
    UaStatus,
    connect,
    (const UaString &sURL, SessionConnectInfo &sessionConnectInfo, SessionSecurityInfo &sessionSecurityInfo, UaSessionCallback *pSessionCallback),
    ());
  ...
  MOCK_METHOD(UaStatus, disconnect, (ServiceSettings & serviceSettings, OpcUa_Boolean bDeleteSubscriptions));

  // Change user for the connection to the OPC UA server
  MOCK_METHOD(UaStatus, changeUser, (ServiceSettings & serviceSettings, UaUserIdentityToken *pUserIdentityToken));

  // Change user and LocaleIds for the connection to the OPC UA server
  MOCK_METHOD(UaStatus, changeUser, (ServiceSettings & serviceSettings, UaUserIdentityToken *pUserIdentityToken, const UaStringArray &localeIds));

  // Change client certificate for the connection to the OPC UA server
  MOCK_METHOD(UaStatus, changeClientCertificate, (const SessionSecurityInfo &sessionSecurityInfo));
  ...
  MOCK_METHOD(
    ...
    (ServiceSettings & serviceSettings, const UaBrowsePaths &browsePaths, UaBrowsePathResults &browsePathResults, UaDiagnosticInfos &diagnosticInfos));

  // Register nodes to create shortcuts in the server.
  MOCK_METHOD(UaStatus, registerNodes, (ServiceSettings & serviceSettings, const UaNodeIdArray &nodesToRegister, UaNodeIdArray &registeredNodesIds));

  // Unregister nodes to delete shortcuts in the server.
  MOCK_METHOD(UaStatus, unregisterNodes, (ServiceSettings & serviceSettings, const UaNodeIdArray &registeredNodesIds));
  ...
  MOCK_METHOD(UaStatus, beginWrite, (ServiceSettings & serviceSettings, const UaWriteValues &nodesToWrite, OpcUa_UInt32 transactionId));
  ...
  MOCK_METHOD(
    UaStatus, deleteSubscription, (ServiceSettings & serviceSettings, UaSubscription **ppUaSubscription, OpcUa_UInt32 waitTimeForTransactionCompletion));
  ...
  MOCK_METHOD(UaStatus, call, (ServiceSettings & serviceSettings, const CallIn &callRequest, CallOut &results));

  // Calls a method of an Object in the OPC server asynchronous
  MOCK_METHOD(UaStatus, beginCall, (ServiceSettings & serviceSettings, const CallIn &callRequest, OpcUa_UInt32 transactionId));
  ...
  MOCK_METHOD(
    UaStatus,
    historyUpdateData,
    (ServiceSettings & serviceSettings, const UpdateDataDetails &updateDataDetails, UaHistoryUpdateResults &results, UaDiagnosticInfos &diagnosticInfos));

  // Delete the history of item values synchronous at OPC server
  MOCK_METHOD(
    UaStatus,
    historyDeleteRawModified,
    (ServiceSettings & serviceSettings, const DeleteRawModifiedDetails &deleteDetails, UaHistoryUpdateResults &results, UaDiagnosticInfos &diagnosticInfos));

  // Delete the history of item values synchronous at OPC server for the given timestamps
  MOCK_METHOD(
    UaStatus,
    historyDeleteAtTime,
    (ServiceSettings & serviceSettings, const DeleteAtTimeDetails &deleteDetails, UaHistoryUpdateResults &results, UaDiagnosticInfos &diagnosticInfos));

  // Update the history of events synchronous at OPC server
  MOCK_METHOD(
    UaStatus,
    historyUpdateEvents,
    (ServiceSettings & serviceSettings, const UpdateEventDetails &updateEventDetails, UaHistoryUpdateResults &results, UaDiagnosticInfos &diagnosticInfos));

  // Delete the history of events synchronous at OPC server for the given event Ids
  MOCK_METHOD(
    UaStatus,
    historyDeleteEvents,
    (ServiceSettings & serviceSettings, const DeleteEventDetails &deleteDetails, UaHistoryUpdateResults &results, UaDiagnosticInfos &diagnosticInfos));
  ...
  MOCK_METHOD(UaStatus, beginHistoryUpdateData, (ServiceSettings & serviceSettings, const UpdateDataDetails &updateDataDetails, OpcUa_UInt32 transactionId));
  ...
  MOCK_METHOD(UaStatus, beginHistoryDeleteAtTime, (ServiceSettings & serviceSettings, const DeleteAtTimeDetails &deleteDetails, OpcUa_UInt32 transactionId));
  ...
  MOCK_METHOD(UaStatus, beginHistoryDeleteEvents, (ServiceSettings & serviceSettings, const DeleteEventDetails &deleteDetails, OpcUa_UInt32 transactionId));
  ...
  MOCK_METHOD(
    UaStatus,
    addReferences,
    (ServiceSettings & serviceSettings, const UaAddReferencesItems &referencesToAdd, UaStatusCodeArray &results, UaDiagnosticInfos &diagnosticInfos));

  // Removes a list of nodes from the OPC server address space
  MOCK_METHOD(
    UaStatus,
    deleteNodes,
    (ServiceSettings & serviceSettings, const UaDeleteNodesItems &nodesToDelete, UaStatusCodeArray &results, UaDiagnosticInfos &diagnosticInfos));

  // Removes a list of references from the OPC server address space
  MOCK_METHOD(
    UaStatus,
    deleteReferences,
    (ServiceSettings & serviceSettings, const UaDeleteReferencesItems &referencesToDelete, UaStatusCodeArray &results, UaDiagnosticInfos &diagnosticInfos));

  // Adds a list of nodes asynchronous to the OPC server address space
  MOCK_METHOD(UaStatus, beginAddNodes, (ServiceSettings & serviceSettings, const UaAddNodesItems &nodesToAdd, OpcUa_UInt32 transactionId));

  // Adds a list of references asynchronous to the OPC server address space
  MOCK_METHOD(UaStatus, beginAddReferences, (ServiceSettings & serviceSettings, const UaAddReferencesItems &referencesToAdd, OpcUa_UInt32 transactionId));

  // Removes a list of nodes asynchronous from the OPC server address space
  MOCK_METHOD(UaStatus, beginDeleteNodes, (ServiceSettings & serviceSettings, const UaDeleteNodesItems &nodesToDelete, OpcUa_UInt32 transactionId));
  ...
  MOCK_METHOD(
    UaStatus,
    queryNext,
    (ServiceSettings & serviceSettings, OpcUa_Boolean releaseContinuationPoint, UaByteString &continuationPoint, UaQueryDataSets &queryDataSets));

  // Cancel outstanding service requests in the OPC UA server
  MOCK_METHOD(UaStatus, cancel, (ServiceSettings & serviceSettings, OpcUa_UInt32 requestHandle, OpcUa_UInt32 &cancelCount));
 ...
 protected:
  ...
  MOCK_METHOD(
    bool,
    verificationError,
    (SessionSecurityInfo * pInfo, OpcUa_Void *pvVerifyContext, const UaByteString &certificateChain, OpcUa_StatusCode uVerificationResult, OpcUa_UInt32 uDepth),
    (override));
};
}  // namespace UaClientSdk
 ...
 public:
  ...
  MOCK_METHOD(
    ...
    (const UaString &sURL,
     ...
     UaClientSdk::UaSessionCallback *pSessionCallback),
    (override));
  MOCK_METHOD(void, SessionUpdateNamespaceTable, (), (override));

  MOCK_METHOD(UaStatus, SessionDisconnect, (UaClientSdk::ServiceSettings & serviceSettings, OpcUa_Boolean bDeleteSubscriptions), (override));
  ...
  MOCK_METHOD(
    UaStatus,
    SessionTranslateBrowsePathsToNodeIds,
    (UaClientSdk::ServiceSettings & serviceSettings,
  ...
  MOCK_METHOD(
    ...
    (ModelOpcUa::NodeId_t nodeId, Dashboard::IDashboardDataClient::newValueCallbackFunction_t callback),
    (override));
};
